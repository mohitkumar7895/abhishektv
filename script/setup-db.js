...
async function main() {
  ...
  const settings = {
    ...
    "seo.default_description": "Professional TV repair in Noida, Noida Extension and Greater Noida with warranty for LED, Smart and Android TVs.",
  ...
  await addPage(
    ...
    [
      {
        ...
        title: "Hero",
        content: {
          eyebrow: "Noida · Doorstep service · Warranty included",
          heading: "Professional TV Repair, Right at Your Doorstep",
          description: "Fast, reliable and affordable repair for LED, Smart and Android TVs across Noida, Noida Extension and Greater Noida.",
          primaryLabel: "Book a Repair",
          primaryHref: "/book-service",
          secondaryLabel: "Call Now",
          secondaryHref: "tel:08510951545",
          image: IMG.tv,
          availabilityText: "Call 9990115217 · Expert technicians available for all major brands",
          badges: ["Doorstep service", "Repair warranty", "Clear estimate", "All major brands"],
    ...
    { title: "Abhishek LED TV Repair Center | TV Repair in Noida", desc: "Expert LED, Smart and Android TV repair at home across Noida, Noida Extension and Greater Noida.", kw: "tv repair noida", schema: "LocalBusiness" },
  );
